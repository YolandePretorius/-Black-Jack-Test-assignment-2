 ...
 * @author 18038659
 */
public class StandTestNoSession {
    ...
    //
    @Test
    public void startNoSessionStand() throws Exception {
        // no game session created should receive 404 request
        assertEquals(HttpStatus.SC_NOT_FOUND, statusRequest("jack/move/stand"));
