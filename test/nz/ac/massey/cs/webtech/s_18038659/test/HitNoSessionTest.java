...
public class HitNoSessionTest {
    ...
    //
    @Test
    public void startNoSessionHit() throws Exception {
        // no game session created should receive 404 request
        assertEquals(HttpStatus.SC_NOT_FOUND, statusRequest("jack/move/hit"));
